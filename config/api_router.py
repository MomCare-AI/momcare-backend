...
core_urlpatterns = [
    ...
    re_path(
        r"^pregnancies/(?P<pregnancy_id>[0-9a-f-]{36})/risk/(?P<assessment_id>[0-9a-f-]{36})/review/?$",
        ReviewRiskView.as_view(),
        name="risk-review",
    ),
    re_path(
        r"^pregnancies/(?P<pregnancy_id>[0-9a-f-]{36})/risk/(?P<assessment_id>[0-9a-f-]{36})/escalate/?$",
