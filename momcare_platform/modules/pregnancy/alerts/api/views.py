...
from momcare_platform.modules.pregnancy.alerts.api.serializers import (
    AlertDetailSerializer,
    AlertSerializer,
    ResolveSerializer,
)
from momcare_platform.modules.pregnancy.alerts.models import Alert
from momcare_platform.modules.pregnancy.alerts.services import acknowledge_alert, resolve_alert
