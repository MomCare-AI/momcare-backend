...
class Command(BaseCommand):
    ...
    def _report(self, now):
        ...
        from momcare_platform.modules.pregnancy.alerts import escalation  # noqa: PLC0415
        from momcare_platform.modules.pregnancy.alerts.models import Alert  # noqa: PLC0415
