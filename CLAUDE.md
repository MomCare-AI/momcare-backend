...
**593 backend tests (4 skipped) as of the 25 Sep 2026 revision, 30 frontend.**
...
```bash
uv run pytest momcare_platform/core -q      # 593 passed, 4 skipped, as of 25 Sep 2026
```
